...
class UI:
    ...
    def draw_main_menu(self):
        ...
        # Title
        title_text = "POKEMON"
        title_surface = self.font_huge.render(title_text, True, Colors.TEXT_DARK)
        title_rect = title_surface.get_rect(center=(self.screen_width // 2, 120))
        self.screen.blit(title_surface, title_rect)
        
        # Subtitle
        subtitle_text = "Press button to start"
        subtitle_surface = self.font_medium.render(subtitle_text, True, Colors.GRAY)
        ...
        # Version
        version_text = "v1.0.0"
        version_surface = self.font_small.render(version_text, True, Colors.GRAY)
    ...
    def _draw_battle_background(self):
        ...
        for i in range(self.screen_height // 2):
            color_value = 135 + int((255 - 135) * (i / (self.screen_height // 2)))
    ...
    def _draw_pokemon_sprite(self, pokemon: Pokemon, position: Tuple[int, int], is_back: bool):
        ...
        sprite = self.load_sprite(sprite_path, (96, 96))
        if sprite:
    ...
    def draw_world_hud(self, player: Player):
        ...
        pygame.draw.rect(self.screen, Colors.MENU_BORDER, panel_rect, 2)
        
        # Player name
        name_text = f"Player: {player.name}"
        ...
        self.screen.blit(money_surface, (20, 45))
        ...
        if player.active_pokemon:
            ...
            self.screen.blit(pokemon_surface, (20, 70))
            ...
            hp_bar_bg = pygame.Rect(200, 73, 80, 10)
            hp_bar_fill = pygame.Rect(200, 73, int(80 * hp_percent), 10)
